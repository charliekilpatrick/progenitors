...
;-
pro legend_astro, items, BOTTOM_LEGEND=bottom, BOX = box, CENTER_LEGEND=center, $
...
;       =====>> CLEAR AREA
        ...
        if not keyword_set(clcol) then clcol=-1
        polyfill,[x,xend,xend,x,x],y + [0,0,ywidth,ywidth,0],/norm,color=clcol
