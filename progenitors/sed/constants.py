...
Includes colors (RGB tuples), physical constants (e.g. SOLAR_LUM_CGS, BB_SCALE),
dust/RSG scaling constants, and alternate column names for photometry tables.
"""
...
def color(r, g, b):
    """
    Convert 0-255 RGB to (r, g, b, 1.0) tuple for matplotlib.
...
# Convert normalized blackbody (synphot) to solar luminosity flux units
